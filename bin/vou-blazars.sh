...
echo Running VOU-Blazars V1.98
echo
...
echo conesearch --db ${HERE}/cats1.ini --catalog eROSITA-eRASS1 --ra $ranh --dec $decnh --radius $sfov --runit arcmin --columns default -o tmp/${pidnm}erosit_erass.1.csv >> tmp/${pidnm}vosearch.txt
